...
export class OpenRouterProvider implements ILLMProvider {
  ...
  async chat(
    ...
    try {
      this.logger.llm("info", "Sending chat request to OpenRouter", {
        model: this.model,
      ...
      this.logger.llm("info", "Received chat response from OpenRouter", {
      ...
      throw new LLMError(`OpenRouter chat failed: ${message}`);
    }
  }
}
